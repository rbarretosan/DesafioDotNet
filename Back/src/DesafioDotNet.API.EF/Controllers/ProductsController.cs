...
namespace DesafioDotNet.API.EF.Controllers
{
    [ApiController]
    [Route("api/v1/[controller]")]
    public class ProductsController: ControllerBase
    {
        private readonly IProductServiceEF _productService;
        public ProductsController(IProductServiceEF productService)
        {
