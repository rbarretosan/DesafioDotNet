...
namespace DesafioDotNet.API.ADO.Controllers
{
    [ApiController]
    ...
    public class ProductsController: ControllerBase
    {
        ...
        public async Task<IActionResult> Put(int id, ProductDto model)
        {
            ...
            {
                return this.StatusCode(StatusCodes.Status500InternalServerError, $"Erro ao tentar atulizar produto. Erro: {ex.Message}");
            }        
        }
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                return await _productService.DeleteProduct(id)?
                    Ok("Deletado"):
                    throw new Exception("Ocorreu um problema nao específico ao deletar produto.");
            }
            catch (Exception ex)
            {
